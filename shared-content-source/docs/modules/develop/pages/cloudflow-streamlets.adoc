...
[source,json]
----
include::1.3.0@docsnippets:ROOT:example$akkastreams-scala/src/main/avro/CallRecord.avsc[]
----
...
[source,scala]
----
include::1.3.0@docsnippets:ROOT:example$akkastreams-scala/src/main/scala/cloudflow/callrecordaggregator/CallRecordIngress.scala[]
----
...
[source,scala]
----
include::1.3.0@docsnippets:ROOT:example$spark-scala/src/main/scala/cloudflow/callrecordaggregator/CallStatsAggregator.scala[tags=docs-schemaAware-example]
----
...
[source,java]
----
include::1.3.0@docsnippets:ROOT:example$akkastreams-java/src/main/java/cloudflow/akkastreamsdoc/FilterStreamlet.java[]
----
...
[source,scala]
----
include::1.3.0@docsnippets:ROOT:example$akkastreams-scala/src/main/scala/cloudflow/akkastreamsdoc/DataFileIngress.scala[]
----
